...
const conf = convict({
  ...
  expressLogFormat: {
    doc: 'Format of request logs from express.',
    env: 'EXPRESS_LOG_FORMAT',
    format: ['sideshow_prod', 'sideshow_dev'],
    default: 'sideshow_dev'
  },
  logPath: {
...
if (conf.get('secret') === 'CHANGE ME') {
  ...
  console.log('*** Using ephemeral cookie secret. ***');
}
