...
const conf = convict({
  server: {
    ...
    googleClientId : {
      ...
      format: function(val) {
        if (typeof val !== "string") {
          throw new Error("invalid type for server.googleClientId");
        }
        if (!val) {
          throw new Error("must supply server.googleClientId");
        }
      },
      default: null
    },
    googleClientSecret : {
      ...
      format: function(val) {
        if (typeof val !== "string") {
          throw new Error("invalid type for server.googleClientSecret");
        }
        if (!val) {
          throw new Error("must supply server.googleClientSecret");
        }
      },
      default: null
    }
